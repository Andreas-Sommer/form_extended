...
g[s]=e}}const m=new RegExp(Object.keys(g).join("|")+"|[̀-ͯ·ʾʼ]","gu"),v=(e,t="NFKD")=>e.normalize(t),y=e=>c(e).reduce(((e,t)=>e+O(t)),""),O=e=>(e=v(e).toLowerCase().replace(m,(e=>g[e]||"")),v(e,"NFC"))
...
for(let e of l)S(e,i)||i.push(e)}else if(s>0&&1==a.size&&!a.has("3")){t+=I(i,!1)
let e=new C
const s=i[0]
s&&e.add(s.last()),i=[e]}}return t+=I(i,!0),t},x=(e,t)=>{if(e)return e[t]},k=(e,t)=>{if(e){for(var i,s=t.split(".");(i=s.shift())&&(e=e[i]););return e}},F=(e,t,i)=>{var s,n
...
else for(var i in e)e.hasOwnProperty(i)&&t(e[i],i)},$=e=>{if(e.jquery)return e[0]
...
i.initEvent(t,!0,!1),e.dispatchEvent(i)},q=(e,t)=>{Object.assign(e.style,t)},D=(e,...t)=>{var i=H(t);(e=z(e)).map((e=>{i.map((t=>{e.classList.add(t)}))}))},R=(e,...t)=>{var i=H(t);(e=z(e)).map((e=>{i.map((t=>{e.classList.remove(t)}))}))},H=e=>{var t=[]
return N(e,(e=>{"string"==typeof e&&(e=e.trim().split(/[\11\12\14\15\40]/)),Array.isArray(e)&&(t=t.concat(e))})),t.filter(Boolean)},z=e=>(Array.isArray(e)||(e=[e]),e),M=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
e=e.parentNode}},B=(e,t=0)=>t>0?e[e.length-1]:e[0],K=(e,t)=>{if(!e)return-1
t=t||e.nodeName
for(var i=0;e=e.previousElementSibling;)e.matches(t)&&i++
return i},Q=(e,t)=>{N(t,((t,i)=>{null==t?e.removeAttribute(i):e.setAttribute(i,""+t)}))},G=(e,t)=>{e.parentNode&&e.parentNode.replaceChild(t,e)},J=(e,t)=>{if(null===t)return
...
function ae(e,t){var i=Object.assign({},U,t),s=i.dataAttr,n=i.labelField,o=i.valueField,r=i.disabledField,l=i.optgroupField,a=i.optgroupLabelField,c=i.optgroupValueField,d=e.tagName.toLowerCase(),u=e.getAttribute("placeholder")||e.getAttribute("data-placeholder")
...
"optgroup"===(t=e.tagName.toLowerCase())?((n=f(i=e))[a]=n[a]||i.getAttribute("label")||"",n[c]=n[c]||h++,n[r]=n[r]||i.disabled,n.$order=n.$order||++g,p.optgroups.push(n),s=n[c],N(i.children,(e=>{m(e,s)}))):"option"===t&&m(e)}))})():(()=>{const t=e.getAttribute(s)
if(t)p.options=JSON.parse(t),N(p.options,(e=>{p.items.push(e[o])}))
else{var r=e.value.trim()||""
if(!i.allowEmptyOption&&!r.length)return
const t=r.split(i.delimiter)
N(t,(e=>{const t={}
t[n]=e,t[o]=e,p.options.push(t)})),p.items=t}})(),Object.assign({},U,p,t)}var ce=0
...
var p
if(D(r,n.wrapperClass,d,u),D(l,n.controlClass),le(r,l),D(a,n.dropdownClass,u),n.copyClassesToDropdown&&D(a,d),D(c,n.dropdownContentClass),le(a,c),$(n.dropdownParent||r).appendChild(a),j(n.controlInput)){p=$(n.controlInput)
E(["autocorrect","autocapitalize","autocomplete","spellcheck"],(e=>{s.getAttribute(e)&&Q(p,{[e]:s.getAttribute(e)})})),p.tabIndex=-1,l.appendChild(p),this.focus_node=p}else n.controlInput?(p=$(n.controlInput),this.focus_node=p):(p=$("<input/>"),this.focus_node=l)
...
D([o,s],t)}(null===t.maxItems||t.maxItems>1)&&e.is_select_tag&&Q(a,{multiple:"multiple"}),t.placeholder&&Q(i,{placeholder:t.placeholder}),!t.splitOn&&t.delimiter&&(t.splitOn=new RegExp("\\s*"+r(t.delimiter)+"+\\s*")),t.load&&t.loadThrottle&&(t.load=ee(t.load,t.loadThrottle)),se(s,"mousemove",(()=>{e.ignoreHover=!1})),se(s,"mouseenter",(t=>{var i=M(t.target,"[data-selectable]",s)
i&&e.onOptionHover(t,i)}),{capture:!0}),se(s,"click",(t=>{const i=M(t.target,"[data-selectable]")
i&&(e.onOptionSelect(t,i),ie(t,!0))})),se(l,"click",(t=>{var s=M(t.target,"[data-ts-item]",l)
...
n==i&&e.isOpen?t.stopPropagation():ie(t,!0)},v=()=>{e.isOpen&&e.positionDropdown()}
se(document,"mousedown",m),se(window,"scroll",v,d),se(window,"resize",v,d),this._destroy=()=>{document.removeEventListener("mousedown",m),window.removeEventListener("scroll",v),window.removeEventListener("resize",v),g&&g.removeEventListener("click",f)},this.revertSettings={innerHTML:a.innerHTML,tabIndex:a.tabIndex},a.tabIndex=-1,a.insertAdjacentElement("afterend",e.wrapper),e.sync(!1),t.items=[],delete t.optgroups,delete t.options,se(a,"invalid",(()=>{e.isValid&&(e.isValid=!1,e.isInvalid=!0,e.refreshState())})),e.updateOriginalInput(),e.refreshItems(),e.close(!1),e.inputState(),e.isSetup=!0,a.disabled?e.disable():a.readOnly?e.setReadOnly(!0):e.enable(),e.on("change",this.onChange),D(a,"tomselected","ts-hidden-accessible"),e.trigger("initialize"),!0===t.preload&&e.preload()}setupOptions(e=[],t=[]){this.addOptions(e),E(t,(e=>{this.registerOptionGroup(e)}))}setupTemplates(){var e=this,t=e.settings.labelField,i=e.settings.optgroupLabelField,s={optgroup:e=>{let t=document.createElement("div")
...
else{switch(e.keyCode){case 65:if(ne(W,e)&&""==t.control_input.value)return ie(e),void t.selectAll()
break
...
case 8:case 46:return void t.deleteSelection(e)}t.isInputHidden&&!ne(W,e)&&ie(e)}}onInput(e){if(this.isLocked)return
...
ie(t)}else"click"===i&&ne(W,t)||"keydown"===i&&ne("shiftKey",t)?e.classList.contains("active")?a.removeActiveItem(e):a.setActiveItemClass(e):(a.clearActiveItems(),a.setActiveItemClass(e))
...
const[s,a]=b(o,e)
i>0&&(d=d.cloneNode(!0),Q(d,{id:l.$id+"-clone-"+i,"aria-selected":null}),d.classList.add("ts-cloned"),R(d,"active"),h.activeOption&&h.activeOption.dataset.value==n&&c&&c.dataset.group===o.toString()&&(v=d)),a.appendChild(d),""!=o&&(u[o]=s)}}var w
...
n.rtl&&(e*=-1),n.inputValue().length||(ne(W,t)||ne("shiftKey",t)?(s=(i=n.getLastActive(e))?i.classList.contains("active")?n.getAdjacent(i,e,"item"):i:e>0?n.control_input.nextElementSibling:n.control_input.previousElementSibling)&&(s.classList.contains("active")&&n.removeActiveItem(i),n.setActiveItemClass(s)):n.moveCaret(e))}moveCaret(e){}getLastActive(e){let t=this.control.querySelector(".last-active")
if(t)return t
...
if(s=$(s),"option"===e||"option_create"===e?t[n.settings.disabledField]?Q(s,{"aria-disabled":"true"}):Q(s,{"data-selectable":""}):"optgroup"===e&&(i=t.group[n.settings.optgroupValueField],Q(s,{"data-group":i}),t.group[n.settings.disabledField]&&Q(s,{"data-disabled":""})),"option"===e||"item"===e){const i=Y(t[n.settings.valueField])
...
t.settings.render.option=(i,o)=>{var r=$(e.call(t,i,o)),l=document.createElement("input")
...
t.on("initialize",(()=>{var e=$(i.html(i))
e.addEventListener("click",(e=>{t.isLocked||(t.clear(),"single"===t.settings.mode&&t.settings.allowEmptyOption&&t.addItem(""),e.preventDefault(),e.stopPropagation())})),t.control.appendChild(e)}))})),de.define("caret_position",(function(){var e=this
...
this.hook("instead","deleteSelection",(i=>!!e.activeItems.length&&t.call(e,i)))})),de.define("no_active_items",(function(){this.hook("instead","setActiveItem",(()=>{})),this.hook("instead","selectAll",(()=>{}))})),de.define("remove_button",(function(e){const t=Object.assign({label:"&times;",title:"Remove",className:"remove",append:!0},e)
var i=this
if(t.append){var s='<a href="javascript:void(0)" class="'+t.className+'" tabindex="-1" title="'+Z(t.title)+'">'+t.label+"</a>"
i.hook("after","setupTemplates",(()=>{var e=i.settings.render.item
i.settings.render.item=(t,n)=>{var o=$(e.call(i,t,n)),r=$(s)
...
s&&t.setTextboxValue(i.text.call(t,s))}}))})),de.define("tag_list",(function(e){const t=this
var i
const s=Object.assign({className:"ts-taglist",title:"Clear All",html:e=>`<ul class="${e.className}"></ul>`,itemHtml:e=>`<li class="ts-taglist-item"><button data-value="${e.value}">${e.text}</button></li>`},e)
t.on("initialize",(()=>{var e,n,o
i=$(s.html(s)),e=t.control,n=i,null==(o=e.parentNode)||o.insertBefore(n,e.nextSibling)})),t.hook("after","setup",(()=>{for(let e in t.options){let n=$(s.itemHtml(t.options[e]))
t.items.indexOf(t.options[e].value)>-1&&(n.style.display="none"),n.firstChild.addEventListener("click",(e=>{e.preventDefault(),t.addItem(e.target.getAttribute("data-value"))})),i.append(n)}})),t.on("item_add",((e,t)=>{i.querySelectorAll(`li > button[data-value="${e}"]`)[0].parentNode.style.display="none"})),t.on("item_remove",((e,t)=>{i.querySelectorAll(`[data-value="${e}"]`)[0].parentNode.style.display=""}))})),de.define("counter",(function(e){this.require("checkbox_options")
const t=this
t.settings.shouldOpen=!0
let i=t.settings.placeholder
const s=Object.assign({placeholderText:"1 option selected|%d options selected"},e)
t.hook("before","setup",(()=>{t.focus_node=t.control,t.settings.placeholder=n(t.items.length)})),t.on("initialize",(()=>{t.settings.placeholder=n(t.items.length),t.inputState()})),t.on("item_add",((e,i)=>{t.settings.placeholder=n(t.items.length)})),t.on("item_remove",((e,i)=>{t.settings.placeholder=n(t.items.length),t.inputState()}))
const n=e=>0===e?i:1===e?s.placeholderText.split("|")[0]:s.placeholderText.split("|")[1].replace("%d",String(t.items.length))})),de}))
var tomSelect=function(e,t){return new TomSelect(e,t)}
//# sourceMappingURL=tom-select.typo3.min.js.map
